...
```
I started off by defining a range from which I want my numbers to be picked from. 1 is stating the number of digits we would like to pick. The coordinates function defines the coordinates in the order in which I'd like them to appear. To convert to polar coordinates (radius, theta), I first calculate the radius and theta, I then define these. 
...
## Question 5
```
# I couldn't figure out how to do this one and will need some help. Will keep trying till the next lab.
```